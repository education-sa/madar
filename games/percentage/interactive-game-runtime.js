(function attachMadarInteractiveGameRuntime(global) {
  ...
  class InteractiveGameRuntime {
    ...
    startSession(difficulty, questionCount, csrfToken) {
      return jsonRequest("/api/student/games/sessions", {
        method: "POST",
        headers: { "Content-Type": "application/json", Accept: "application/json", "X-CSRF-Token": csrfToken },
        body: JSON.stringify({ gameKey: this.gameKey, difficulty, questionCount }),
      });
    }

    submitAnswer(sessionId, questionIndex, optionId, csrfToken) {
      return jsonRequest(`/api/student/games/sessions/${encodeURIComponent(sessionId)}/answers`, {
        method: "POST",
        headers: { "Content-Type": "application/json", Accept: "application/json", "X-CSRF-Token": csrfToken },
        body: JSON.stringify({ questionIndex, optionId }),
      });
    }

    saveAttempt(sessionId, csrfToken) {
